...
export default ()=>{
    ...
    return(<>
        ...
        <section ref={introSection}>
            <h2>Giriş</h2>
            <p className="article-p"> Yenilebilir enerji kaynaklarının çevreye olan etkisi benzer oldukları için onları hep birlikte ele almaya karar verdim. Bu enerji kaynakları her ne kadar çevre için yararlı olabilse de beraberinde birtakım sorunlar getirmektedirler. Bakalım onlar nelerdir?</p>
        </section>
